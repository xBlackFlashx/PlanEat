# PlanEat — Tu plan de comidas, resuelto

Source: http://localhost:3999/
...
| `extracted/tokens.json` | Design tokens: 20 colors, 4 fonts, 13 headings, 0 CTAs |
...
- **Colors**: #0F172A (accent), #F8FAFC (bg-light), #FFFFFF (bg-light), #E2E8F0 (bg-light), #475569 (neutral), #047857 (accent), #B45309 (accent), #2563EB (accent), #7C3AED (accent), #CBD5E1 (surface-light)
- **Fonts**: Inter (100-900 variable), Poppins (400), __nextjs-Geist (400-600 variable), __nextjs-Geist Mono (400-600 variable)
