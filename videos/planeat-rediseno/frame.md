...
colors:
  ...
  accent-medium: "rgba(4, 120, 87, 0.15)"
  border: "rgba(4, 120, 87, 0.2)"
  card-bg: "rgba(4, 120, 87, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  # — reading ramp: Inter, exactly PlanEat's own "trabajo" role (body/chrome/numbers) —
  ...
  # — display ramp: Poppins, PlanEat's own "voz" role, reserved for titles only —
  # numerals (stat-num/metric-value) stay Inter: PlanEat's real system never puts a
  # number in the voz font (globals.css: "nunca en un número, nunca en negrita").
  h3:      { fontFamily: "Poppins", cqw: 1.25, weight: 400, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "Inter", cqw: 1.9, weight: 600, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "Poppins", cqw: 2.4, weight: 400, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "Poppins", cqw: 2.6, weight: 400, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "Inter", cqw: 3.0, weight: 600, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "Poppins", cqw: 4.2, weight: 400, lineHeight: 1.08, tracking: "-0.01em", color: "text" }
  quote-mark:{ fontFamily: "Poppins", cqw: 8.0, weight: 400, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
- **Fonts** — set to **Poppins** (display: h1/h2/h3/blockquote/quote-mark only) / **Inter** (body, chrome, and ALL numerals/stats — PlanEat's own rule is "voz" fonts never carry a number); ignore any "Inter (display)" phrasing lingering in the prose below.
